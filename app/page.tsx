    ...
    <>
      <style>{`
        ...
        .hp-nav {
          ...
          border-bottom: 1px solid rgba(92, 164, 115, 0.15);
        }
        .hp-nav-brand {
          display: flex;
          align-items: center;
        ...
        .hp-nav-logo {
          border-radius: 50%;
          border: 1.5px solid rgba(92, 164, 115, 0.4);
          object-fit: cover;
        }
        .hp-nav-name {
          font-size: 1rem;
        ...
        .hp-hero {
          position: relative;
          background: linear-gradient(155deg, #1b4332 0%, #2d6a4f 35%, #40916c 65%, #52b788 100%);
          overflow: hidden;
        ...
        .hp-orb-1 {
          ...
          top: -160px;
          right: -120px;
          animation: hp-drift-a 36s ease-in-out infinite;
        }
        .hp-orb-2 {
          width: 340px;
          height: 340px;
          bottom: -100px;
          left: -100px;
          animation: hp-drift-b 28s ease-in-out infinite;
        }
        .hp-orb-3 {
          width: 160px;
          height: 160px;
          ...
          animation: hp-drift-a 22s ease-in-out infinite reverse;
        }
        .hp-orb-4 {
          width: 64px;
          height: 64px;
          top: 70%;
          left: 20%;
          background: rgba(216, 164, 17, 0.22);
          border-color: rgba(216, 164, 17, 0.28);
          animation: hp-drift-b 18s ease-in-out infinite;
        }
        .hp-orb-5 {
          width: 240px;
          height: 240px;
          ...
          animation: hp-drift-a 30s ease-in-out infinite 5s;
        }
        .hp-grid {
          position: absolute;
          inset: 0;
        ...
        .hp-hero-content {
          ...
          max-width: 760px;
          width: 100%;
          animation: hp-fade-up 0.8s ease both;
        }
        .hp-hero-logo {
          border-radius: 50%;
        ...
        .hp-cta-wrap {
          ...
          animation: hp-fade-up 0.8s 0.2s ease both;
        }
        .hp-stat-chips {
          display: flex;
          align-items: center;
          ...
          gap: 0.75rem;
          flex-wrap: wrap;
          animation: hp-fade-up 0.8s 0.35s ease both;
        }
        .hp-chip {
          display: flex;
          align-items: center;
        ...
        .hp-feat-card {
          ...
          box-shadow:
            ...
            0 4px 16px rgba(92, 164, 115, 0.06);
          transition:
            transform 0.2s ease,
        ...
        .hp-feat-card:hover {
          ...
          box-shadow: 0 8px 32px rgba(45, 106, 79, 0.14);
          border-color: #c8ddd0;
        }
        .hp-feat-card:nth-child(1) { animation-delay: 0.05s; }
        .hp-feat-card:nth-child(2) { animation-delay: 0.1s; }
        .hp-feat-card:nth-child(3) { animation-delay: 0.15s; }
        .hp-feat-card:nth-child(4) { animation-delay: 0.2s; }
        .hp-feat-card:nth-child(5) { animation-delay: 0.25s; }
        .hp-feat-card:nth-child(6) { animation-delay: 0.3s; }
        .hp-feat-icon {
          width: 42px;
          height: 42px;
          border-radius: 12px;
          background: linear-gradient(135deg, #e8f5ee 0%, #d4eddc 100%);
          display: flex;
          align-items: center;
          justify-content: center;
          color: #2d6a4f;
        ...
        .hp-stat-item:not(:last-child)::after {
          ...
          height: 50%;
          width: 1px;
          background: rgba(92, 164, 115, 0.2);
        }
        .hp-stat-value {
          font-family: "Plus Jakarta Sans", sans-serif;
          font-size: 3.5rem;
        ...
        .hp-cta-section {
          position: relative;
          background: linear-gradient(155deg, #1b4332 0%, #2d6a4f 40%, #40916c 75%, #52b788 100%);
          overflow: hidden;
          padding: 5.5rem 2rem;
          text-align: center;
        }
        ...
        @keyframes hp-drift-a {
          ...
          33% {
            transform: translate(20px, -16px) scale(1.025);
          }
          66% {
            transform: translate(-12px, 10px) scale(0.975);
          }
        }
        ...
        @keyframes hp-pulse-dot {
          ...
          50% {
            box-shadow: 0 0 0 5px rgba(116, 198, 157, 0.12);
          }
        }
