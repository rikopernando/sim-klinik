      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">{stats.totalBeds} bed total</p>
          </CardContent>
        </Card>

        <Card className="border-green-200 bg-green-50">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-green-700">Kamar Kosong</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-yellow-200 bg-yellow-50">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-yellow-700">Terisi Sebagian</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-blue-200 bg-blue-50">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-blue-700">Tingkat Hunian</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-blue-700">{overallOccupancyRate}%</div>
      ...
      {isLoading ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {filteredRooms.map((room) => (
            <Card key={room.id} className={`border-l-4 ${getRoomStatusColor(room)}`}>
              <CardHeader>
              ...
              <CardContent className="space-y-3">
                ...
                {/* Action Button */}
                <Button size="sm" className="w-full" disabled={room.occupiedBeds === room.bedCount}>
