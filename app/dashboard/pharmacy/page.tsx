            ...
            <TabsList className="inline-flex">
              ...
              <TabsTrigger value="expiring" className="gap-2">
                ...
                {expiringDrugs.all.length > 0 && (
                  <Badge className="rounded-full bg-orange-100 px-1.5 py-0.5 text-[10px] leading-none font-semibold text-orange-700 tabular-nums dark:bg-orange-900/40 dark:text-orange-300">
