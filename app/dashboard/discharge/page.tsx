        ...
        <div className="container mx-auto p-6 max-w-4xl">
            ...
            <div className="mb-6">
                ...
                <p className="text-muted-foreground">
                    Buat ringkasan medis untuk pasien yang akan pulang
                </p>
            </div>
            ...
            <Card className="mb-6">
                ...
                <CardContent>
                    <div className="flex gap-4">
                        ...
                        <Button
                            onClick={() =>
                                visitId && checkCanDischarge(parseInt(visitId))
                            }
                ...
                <form onSubmit={handleSubmit}>
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Lengkapi informasi berikut sebelum pasien pulang
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            ...
                            <div>
                                ...
                                <Textarea
                                    ...
                                    onChange={(e) =>
                                        handleInputChange("admissionDiagnosis", e.target.value)
                                    }
                            ...
                            <div>
                                ...
                                <Textarea
                                    ...
                                    onChange={(e) =>
                                        handleInputChange("dischargeDiagnosis", e.target.value)
                                    }
                            ...
                            <div>
                                ...
                                <Textarea
                                    ...
                                    onChange={(e) =>
                                        handleInputChange("clinicalSummary", e.target.value)
                                    }
                            ...
                            <div>
                                ...
                                <Textarea
                                    ...
                                    onChange={(e) =>
                                        handleInputChange("proceduresPerformed", e.target.value)
                                    }
                            ...
                            <div>
                                <Label htmlFor="medicationsOnDischarge">
                            ...
                            <div>
                                ...
                                <Textarea
                                    ...
                                    onChange={(e) =>
                                        handleInputChange("dischargeInstructions", e.target.value)
                                    }
