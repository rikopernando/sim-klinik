...
| **No.** | **User Story** |
| --- | --- |
| **2.1** | **Sebagai Pemilik Klinik**, saya ingin melihat laporan pendapatan dan penyakit terbanyak secara *real-time* agar saya bisa merencanakan stok obat dan SDM dengan lebih baik. |
...
| **API Integration** | **Supabase Edge Functions** | Digunakan untuk menangani *webhooks* dan integrasi API pihak ketiga (BPJS/SatuSehat). |
...
| **Frontend Pasien** | **Next.js PWA** | Aplikasi ringan yang bisa di-*install* di HP pasien tanpa melalui Play Store/App Store. |
