...
| 3   | Cashier            | /dashboard/cashier                   | app/dashboard/cashier/page.tsx                   | ✅ Done — sticky footer on ProcessPaymentDialog, brand colors → theme tokens, skeleton loading + empty state icon in QueueSidebar, Button component for print CTA |
