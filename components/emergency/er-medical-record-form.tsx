        ...
        <div className="space-y-6">
            ...
            {success && (
                <Alert className="border-green-500 bg-green-50 text-green-700">
                    ...
                    <AlertDescription>
                        Rekam medis UGD berhasil disimpan!
                    </AlertDescription>
                </Alert>
            )}
            ...
            <form className="space-y-6">
                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            ...
                            {errors.emergencyActions && (
                                <p className="text-sm text-destructive">
                                    {errors.emergencyActions.message}
                                </p>
                            )}
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            {errors.workingDiagnosis && (
                                <p className="text-sm text-destructive">
                                    {errors.workingDiagnosis.message}
                                </p>
                            )}
                        </div>
                    </CardContent>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            ...
                            >
                                <SelectTrigger
                                    className={errors.disposition ? "border-destructive" : ""}
                                >
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="observation">
                                        👁️ Observasi (Ruang Observasi UGD)
                                    </SelectItem>
                                </SelectContent>
                            </Select>
                            {errors.disposition && (
                ...
                {/* Form Actions */}
                {!isLocked && (
                    <div className="flex gap-3 justify-end sticky bottom-0 bg-background p-4 border-t">
                        <Button
                            type="button"
                            variant="outline"
