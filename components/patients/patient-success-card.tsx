    ...
    <Card className="border-green-200 bg-green-50 dark:border-green-900 dark:bg-green-950">
      <CardContent className="space-y-6 p-8">
          ...
          <CardContent className="space-y-3">
            <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                ...
                <div className="text-primary text-2xl font-bold">{patient.mrNumber}</div>
              </div>
              ...
              {/* Phone */}
              <div>
                <span className="text-muted-foreground font-medium">Telepon:</span>
              ...
              {patient.bloodType && (
                <div>
                  <span className="text-muted-foreground font-medium">Golongan Darah:</span>
              ...
              {patient.insuranceType && (
                <div>
                  <span className="text-muted-foreground font-medium">Jenis Jaminan:</span>
                  <div>
              ...
              {patient.insuranceNumber && (
                <div>
                  <span className="text-muted-foreground font-medium">Nomor Jaminan:</span>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
          ...
          <Button onClick={onRegisterVisit} variant="outline" size="lg" className="gap-2">
            <FileText className="h-4 w-4" />
            Daftarkan Kunjungan
          </Button>
          <Button onClick={onViewList} variant="outline" size="lg" className="gap-2">
