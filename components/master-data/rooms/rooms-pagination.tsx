/**
 * Rooms Pagination Component
 * Navigation controls for paginated rooms list using shadcn pagination
 */
...
import { Pagination as PaginationInfo } from "@/types/api"
...
export function RoomsPagination({ pagination, onPageChange }: RoomsPaginationProps) {
