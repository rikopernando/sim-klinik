...
export async function registerPatient(
    ...
    const response = await axios.post<{ data: RegisteredPatient }>(
        "/api/patients",
        payload
    );
...
export async function updatePatient(
    ...
    const response = await axios.patch<{ data: RegisteredPatient }>(
        `/api/patients/${id}`,
        payload
    );
...
export async function getPatient(id: number): Promise<RegisteredPatient> {
    const response = await axios.get<{ data: RegisteredPatient }>(
        `/api/patients/${id}`
    );
